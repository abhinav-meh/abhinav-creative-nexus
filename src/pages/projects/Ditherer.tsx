...
import { ExternalLink, Download, Upload, Palette, Zap, Lock, Smartphone } from "lucide-react"
...
const Ditherer = () => {
  ...
  return (
    <ProjectLayout
      title="Dither-er"
      subtitle="Fast, client-side image dithering tool that converts photos to bitmap-style aesthetics. All processing happens in your browser - no uploads, complete privacy."
