...
const Woz = () => {
  const buttons = (
    <>
      <Button variant="outline" size="sm" asChild>
        <a href="https://www.woz.ai/" target="_blank" rel="noopener noreferrer">
          <ExternalLink className="w-4 h-4 mr-2" />
          Visit Website
        </a>
      </Button>
      <Button variant="outline" size="sm" asChild>
        <a href="https://chat.woz.ai/nike" target="_blank" rel="noopener noreferrer">
          <ExternalLink className="w-4 h-4 mr-2" />
          Visit Chatbot
        </a>
      </Button>
  ...
  return (
    <ProjectLayout title="WOZ.AI" subtitle="Conversational AI Analytics Platform" icon={wozLogo} buttons={buttons}>
      ...
      <div className="bg-card/50 rounded-lg p-8 border border-border mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div><strong className="text-foreground">Role:</strong> Product Designer & Developer</div>
          <div><strong className="text-foreground">Timeline:</strong> 3 months</div>
          <div><strong className="text-foreground">Team:</strong> 4 engineers, 2 designers</div>
          <div><strong className="text-foreground">Platform:</strong> Web Application</div>
        </div>
      </div>

      <div className="mb-12">
        <h2 className="text-3xl font-semibold mb-8 text-center">Platform Overview</h2>
        <ImageLightbox src={wozOverview} alt="WOZ.AI Dashboard Overview showing analytics, active users, and conversation metrics" className="w-4/5 max-w-4xl mx-auto rounded-lg border border-border mb-6 shadow-lg" />
      ...
      <div className="mb-12">
        ...
        <ImageLightbox src={wozAccountSelect} alt="Product selection interface showing different chatbots for Nike products with user and conversation counts" className="w-4/5 max-w-4xl mx-auto rounded-lg border border-border mb-6 shadow-lg" />
        <p className="text-muted-foreground mb-8 text-center max-w-3xl mx-auto">
      ...
      <div className="mb-12">
        ...
        <ImageLightbox src={wozConversationAnalysis} alt="Detailed conversation analysis showing sentiment tracking, keyword clouds, and performance metrics" className="w-4/5 max-w-4xl mx-auto rounded-lg border border-border mb-6 shadow-lg" />
        <p className="text-muted-foreground mb-8 text-center max-w-3xl mx-auto">
      ...
      <div className="mb-12">
        ...
        <ImageLightbox src={wozCustomerData} alt="Customer data table showing user information, ratings, and interaction history" className="w-4/5 max-w-4xl mx-auto rounded-lg border border-border mb-6 shadow-lg" />
        <p className="text-muted-foreground mb-8 text-center max-w-3xl mx-auto">
      ...
      <div className="mb-12">
        ...
        <div className="mb-8">
          <ImageLightbox src={wozChatbotWelcome} alt="Chatbot welcome interface with personalized Nike product recommendations and quick action cards" className="w-4/5 max-w-4xl mx-auto rounded-lg border border-border mb-4 shadow-lg" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div>
            <ImageLightbox src={wozChatbotVoice} alt="Voice interaction interface with circular progress indicator and clean typography" className="w-full rounded-lg border border-border mb-4 shadow-lg" />
            <p className="text-muted-foreground text-center text-sm">
              Voice-enabled interface with elegant loading states and seamless speech-to-text integration.
            </p>
          </div>
          <div>
            <ImageLightbox src={wozChatbotProduct} alt="Product showcase interface displaying Nike apparel with detailed descriptions and purchase options" className="w-full rounded-lg border border-border mb-4 shadow-lg" />
            <p className="text-muted-foreground text-center text-sm">
