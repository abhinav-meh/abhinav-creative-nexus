...
const Begig = () => {
  const buttons = (
    <Button variant="outline" size="sm" asChild>
      <a href="https://begig.io/" target="_blank" rel="noopener noreferrer">
  ...
  return (
    <ProjectLayout title="BeGig" subtitle="Tech freelancing marketplace" icon={begigLogo} buttons={buttons}>
      ...
      <div className="mb-16">
        ...
        <div className="mb-16">
          <ImageLightbox src={clientSignup} alt="Client signup with tech skills selection" className="w-4/5 max-w-4xl mx-auto rounded-lg border border-border mb-6 shadow-lg" />
        ...
        <div className="mb-16">
          <ImageLightbox src={clientGigPosting} alt="Comprehensive gig posting form" className="w-4/5 max-w-4xl mx-auto rounded-lg border border-border mb-6 shadow-lg" />
          <p className="text-muted-foreground text-center max-w-3xl mx-auto">
        ...
        <div className="mb-16">
          <ImageLightbox src={clientDashboard} alt="Client dashboard showing project overview" className="w-4/5 max-w-4xl mx-auto rounded-lg border border-border mb-6 shadow-lg" />
          <p className="text-muted-foreground text-center max-w-3xl mx-auto">
        ...
        <div className="mb-16">
          <ImageLightbox src={clientGigDetails} alt="Detailed gig management interface" className="w-4/5 max-w-4xl mx-auto rounded-lg border border-border mb-6 shadow-lg" />
          <p className="text-muted-foreground text-center max-w-3xl mx-auto">
      ...
      <div className="mb-16">
        ...
        <div className="mb-16">
          <ImageLightbox src={freelancerSignup} alt="Freelancer onboarding with skills and experience" className="w-4/5 max-w-4xl mx-auto rounded-lg border border-border mb-6 shadow-lg" />
          <p className="text-muted-foreground text-center max-w-3xl mx-auto">
        ...
        <div className="mb-16">
          <ImageLightbox src={freelancerDashboard} alt="Freelancer dashboard with recommended gigs" className="w-4/5 max-w-4xl mx-auto rounded-lg border border-border mb-6 shadow-lg" />
          <p className="text-muted-foreground text-center max-w-3xl mx-auto">
        ...
        <div className="mb-16">
          <ImageLightbox src={freelancerProposal} alt="Proposal creation interface with milestones" className="w-4/5 max-w-4xl mx-auto rounded-lg border border-border mb-6 shadow-lg" />
          <p className="text-muted-foreground text-center max-w-3xl mx-auto">
        ...
        <div className="mb-16">
          <ImageLightbox src={freelancerPayment} alt="Payment expectation setting interface" className="w-4/5 max-w-4xl mx-auto rounded-lg border border-border mb-6 shadow-lg" />
          <p className="text-muted-foreground text-center max-w-3xl mx-auto">
