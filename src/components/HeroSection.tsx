    ...
    <section className="relative h-[70vh] overflow-hidden bg-hero-gradient animate-gradient-shift bg-[length:400%_400%] font-space-mono">
      ...
      <div className="relative z-10 container mx-auto px-6 h-full flex flex-col justify-center">
        <div className="max-w-4xl">
          <div className="mb-6 text-sm font-mono text-foreground/80 animate-fade-in">
            Hello, visitor <span className="font-bold text-primary">#{visitorCount.toLocaleString()}</span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-slide-up">
            <span className="block text-foreground">Abhinav Mehrotra</span>
          </h1>
          ...
          <div className="text-xl md:text-2xl text-foreground/90 font-light mb-8 animate-slide-up [animation-delay:0.2s]">
            ...
            <span className="text-category-developer"> Developer</span>
          </div>
          
          <div className="text-lg md:text-xl text-foreground/80 max-w-3xl leading-relaxed animate-slide-up [animation-delay:0.4s]">
            Researching, prototyping, designing and testing by day.{' '}
            <span className="text-primary font-medium">Coding, no-coding, launching products by night.</span>
          </div>
          
          {!showEmail && (
            <div className="mt-8 text-sm text-foreground/60 font-mono animate-slide-up [animation-delay:0.6s]">
              Press <kbd className="px-2 py-1 bg-secondary rounded text-foreground">E</kbd> to reveal email
            </div>
          )}
