...
export default function ProjectCard({ title, description, category, icon }: ProjectCardProps) {
  return (
    <div className="group bg-card-gradient border border-border rounded-lg p-6 hover:shadow-card transition-all duration-300 hover:scale-[1.02] cursor-pointer animate-fade-in">
