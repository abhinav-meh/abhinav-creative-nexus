...
interface ProjectCardProps {
  title: string
  description: string
  category: 'Design' | 'Development' | 'Game Development' | 'Research'
  icon?: string
}
...
const categoryStyles = {
  ...
  'Game Development': 'bg-category-experiment/20 text-category-experiment border-category-experiment/30',
